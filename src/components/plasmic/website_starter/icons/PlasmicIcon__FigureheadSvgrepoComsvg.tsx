...
export type FigureheadSvgrepoComsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FigureheadSvgrepoComsvgIcon(
  props: FigureheadSvgrepoComsvgIconProps
) {
...
export default FigureheadSvgrepoComsvgIcon;
/* prettier-ignore-end */
